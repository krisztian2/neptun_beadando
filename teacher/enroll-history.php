...
<head>
    ...
    <title>Vizsgára jelentkezők</title>
 ...
 ?>
    ...
    <div class="content-wrapper">
        <div class="container">
              <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Vizsgára jelentkezők  </h1>
                    </div>
                </div>
                <div class="row" >
